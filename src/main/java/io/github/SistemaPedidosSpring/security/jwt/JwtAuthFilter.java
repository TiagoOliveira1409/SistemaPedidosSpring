...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    final private UsuarioServiceImpl usuarioService;
    ...
    protected void doFilterInternal(
        ...
        if (authorization != null && authorization.startsWith("Bearer ")) {
            ...
            if (isValid) {
                String usuarioLogin = jwtService.obterLogin(token);
                UserDetails usuario = usuarioService.loadUserByUsername(usuarioLogin);
